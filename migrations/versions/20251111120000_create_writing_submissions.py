...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("teacher_spelling_score", sa.Float(), nullable=True),
        sa.Column("teacher_grammar_score", sa.Float(), nullable=True),
        sa.Column("teacher_structure_score", sa.Float(), nullable=True),
        sa.Column("teacher_vocabulary_score", sa.Float(), nullable=True),
