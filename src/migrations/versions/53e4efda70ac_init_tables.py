...
Revision ID: 53e4efda70ac
Revises: 3f47073e3f8c
Create Date: 2025-10-06 02:00:02.334560
...
revision: str = '53e4efda70ac'
down_revision: Union[str, None] = '3f47073e3f8c'
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('target_exp', sa.Integer(), nullable=False),
    sa.Column('target_lessons', sa.Integer(), nullable=False),
    ...
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('question_id', sa.Integer(), nullable=False),
    sa.Column('last_wrong_answer', sa.String(length=1000), nullable=True),
...
def downgrade() -> None:
    ...
    sa.UniqueConstraint('uuid', name=op.f('user_uuid_key'), postgresql_include=[], postgresql_nulls_not_distinct=False)
    )
